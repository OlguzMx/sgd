...
<head>
    ...
    <title>Entrada de Mat/Eq a bodega</title>
...
<body>
    <header>
        <p class="fecha">Villahermosa, Tabasco a
            {{ \Carbon\Carbon::parse($documento->entrada_almacen->fecha)->translatedFormat('d \d\e F \d\e Y') }}
        </p>
        <p class="font-semibold name-cliente">{{ $documento->entrada_almacen->name_cliente }}</p>
