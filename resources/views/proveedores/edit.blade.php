        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-8 py-2 flex flex-col items-center md:block ">
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <p class="my-2 text-sm leading-6 text-gray-600">Ingrese la información requerida para editar el proveedor.</p>
                    <form action="{{ route('proveedores.update', $Proveedor->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" name="name" id="name" value="{{ $Proveedor->name }}" placeholder="Ej: Westcon Mexico, S.A. de C.V" class="@error('name') md:border border-red-500 @enderror block w-full rounded-md border-0 py-1.5 
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input id="name_contacto" name="name_contacto" type="text" value="{{ $Proveedor->name_contacto }}" placeholder="Ej: Julio Rodriguez" class="@error('name_contacto') md:border border-red-500 @enderror block w-full rounded-md border-0 py-1.5 
                                        text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 
                                        placeholder:text-gray-400 focus:ring-2 focus:ring-inset 
                                        focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    @error('name_contacto')
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" name="direccion" id="direccion" value="{{ $Proveedor->direccion }}" placeholder="Ej: Av. Insurgentes Sur 730 Piso 11 Col. Del Valle, Del. Benito Juárez, C.P. 03100 Ciudad de México" class="@error('direccion') md:border border-red-500 @enderror block w-full rounded-md border-0 py-1.5 
                                        text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" name="telefono" id="telefono" value="{{ $Proveedor->telefono }}" placeholder="Ej: 9922110088" class="@error('telefono') md:border border-red-500 @enderror block w-full rounded-md border-0 
