...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- INICIO - VISTA DE EDITAR USUARIO -->

            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-8 py-2">
                <div class="border-b border-gray-900/10 pb-12">
                    <h2 class="text-base font-semibold leading-7 text-gray-900">Datos del Usuario</h2>
                    <p class="mt-1 text-sm leading-6 text-gray-600">Ingrese la información requerida para editar al usuario.</p>
                    <form action="{{ route('usuarios.update', $User->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" name="name" id="name" value="{{ $User->name }}" autocomplete="name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            ...
                            <!-- INICIO - EDITAR REPETIR CONTRASEÑA -->
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <select id="rol" name="rol" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
                                        <option value="">Seleccione un Rol</option>
                                        <option value="1" {{$User->rol == '1'?'selected':''}}>Administrador</option>
                                        <option value="2" {{$User->rol == '2'?'selected':''}}>Operador</option>
                                    </select>
                                </div>
                            </div>
