                ...
                <div class="flex flex-col mt-10">
                    <div class="py-2 overflow-x-auto">
                        ...
                        <div class="flex items-center gap-4 mb-3">
                            <a href="{{ route('usuarios.create') }}" class="uppercase text-sm font-semibold bg-orange-500 hover:bg-indigo-700 text-white px-2 py-1 rounded">
                                Agregar usuario
                            </a>
                        </div>
                                    ...
                                    <tr class="border-t hover:bg-gray-100" id="user_{{ $user->id }}">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <div class="flex items-center gap-4">
                                                ...
                                                <a href="#" title="Eliminar al Usuario" class="bg-red-500 hover:bg-red-600 text-white p-1 rounded" title="Eliminar Usuario" onclick="deleteUser({{ $user->id }})">
                        ...
                        <!-- INICIO - PAGINACIÓN DE USUARIOS -->

                        <div class="py-2">
                            {{ $User->links()}}
                        </div>

                        <!-- FIN - PAGINACIÓN DE USUARIOS -->
