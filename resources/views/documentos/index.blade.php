                            ...
                            <div
                                ...
                                @if ($documento->tipo_documento_id === 1)
                                    <a href="{{ route('documentos.showRemision', $documento->id) }}"
                                        title="Ver más de: {{ $documento->tipo_documento->name }}"
                                ...
                                @elseif($documento->tipo_documento_id === 2)
                                    <a href="{{ route('documentos.showCotizacion', $documento->id) }}"
                                        title="Ver más de: {{ $documento->tipo_documento->name }}"
                                        class="text-white font-semibold text-sm hover:text-blue-200 transition duration-300 ease-in-out">Ver
                                        más
                                    </a>
                                @elseif($documento->tipo_documento_id === 3)
                                    <a href="{{ route('documentos.showOrdenCompra', $documento->id) }}"
                                        title="Ver más de: {{ $documento->tipo_documento->name }}"
                                        class="text-white font-semibold text-sm hover:text-blue-200 transition duration-300 ease-in-out">Ver
                                        más
                                    </a>
                                ...
                                @elseif($documento->tipo_documento_id === 5)
                                    <a href="{{ route('documentos.showEntradaAlmacen', $documento->id) }}"
                                        title="Ver más de: {{ $documento->tipo_documento->name }}"
                                        class="text-white font-semibold text-sm hover:text-blue-200 transition duration-300 ease-in-out">Ver
                                        más
                                    </a>
                                @elseif($documento->tipo_documento_id === 6)
                                    <a href="{{ route('documentos.showSalidaAlmacen', $documento->id) }}"
                                        title="Ver más de: {{ $documento->tipo_documento->name }}"
                                        class="text-white font-semibold text-sm hover:text-blue-200 transition duration-300 ease-in-out">Ver
                                        más
                                    </a>
                                ...
                                <div class="flex justify-center items-center gap-2">
                                    @if ($documento->tipo_documento_id === 1)
                                        {{-- Export --}}
                                        <a href="{{ route('pdf.remision', $documento->id) }}"
                                            title="PDF de {{ $documento->tipo_documento->name }}"
                                        ...
                                        <a href="{{ route('documentos.editRemision', $documento->id) }}"
                                    ...
                                    @elseif ($documento->tipo_documento_id === 2)
                                        ...
                                        <a href="{{ route('documentos.editCotizacion', $documento->id) }}"
                                            title="Editar {{ $documento->tipo_documento->name }}"
                                            class="bg-white text-blue-600 hover:text-blue-800 p-1 rounded-full">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    ...
                                    @elseif ($documento->tipo_documento_id === 4)
                                    {{-- Export --}}
                                        <a href="{{ route('pdf.garantia', $documento->id) }}"
                                            title="PDF de {{ $documento->tipo_documento->name }}"
                                            class="bg-white text-blue-600 hover:text-blue-800 p-1 rounded-full">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    ...
                                    @elseif ($documento->tipo_documento_id === 5)
                                    {{-- Export --}}
                                        <a href="{{ route('pdf.entrada', $documento->id) }}"
                                            title="PDF de {{ $documento->tipo_documento->name }}"
                                            class="bg-white text-blue-600 hover:text-blue-800 p-1 rounded-full">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        ...
                                        <a href="{{ route('documentos.editEntradaAlmacen', $documento->id) }}"
                                            title="Editar {{ $documento->tipo_documento->name }}"
                                            class="bg-white text-blue-600 hover:text-blue-800 p-1 rounded-full">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    ...
                                    @elseif ($documento->tipo_documento_id === 6)
                                    {{-- Export --}}
                                        <a href="{{ route('pdf.salida', $documento->id) }}"
                                            title="PDF de {{ $documento->tipo_documento->name }}"
                                            class="bg-white text-blue-600 hover:text-blue-800 p-1 rounded-full">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        ...
                                        <a href="{{ route('documentos.editSalidaAlmacen', $documento->id) }}"
                                            title="Editar {{ $documento->tipo_documento->name }}"
                                            class="bg-white text-blue-600 hover:text-blue-800 p-1 rounded-full">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
