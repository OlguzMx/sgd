            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-8 py-2">
                <div class=" pb-12">
                    ...
                    <div class="mt-8">
                        ...
                        <!-- INICIO - VISTA PREVIA ORDEN DE COMPRA -->

                        <div class="border px-3 py-6 rounded-sm">
                            <div class="mt-2">
                                <img src="{{ asset('img/logo-arsite.png') }}" alt="Logo" width="400px" class="my-8">
                                ...
                                <div class="grid grid-cols-2 gap-2 p-4">
                                    <div style="padding:6px; border:solid 1px; border-radius:10px;">
                                    ...
                                    <div style="padding:6px; border:solid 1px; border-radius:10px;">
                                        ...
                                        <p class="font-bold">Moneda: <span class="font-normal">Dólares</span></p>
                                    </div>
                                </div>
                                ...
                                <table class="border-collapse">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-collapse border  px-4 py-2"> {{ $Documentos->orden_compra->name_cliente }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border-collapse border  px-4 py-2 font-bold">Domicilio</td>
                                            <td class="border-collapse border  px-4 py-2">{{ $Documentos->orden_compra->domicilio }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border-collapse border  px-4 py-2 font-bold">Ciudad y Estado</td>
                                            <td class="border-collapse border  px-4 py-2">{{ $Documentos->orden_compra->ubicacion }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border-collapse border  px-4 py-2 font-bold">Código Postal</td>
                                            <td class="border-collapse border  px-4 py-2">{{ $Documentos->orden_compra->codigo_postal }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border-collapse border  px-4 py-2 font-bold">Contacto Cliente</td>
                                            <td class="border-collapse border  px-4 py-2">{{ $Documentos->orden_compra->contacto_cliente }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border-collapse border  px-4 py-2 font-bold">Teléfono</td>
                                            <td class="border-collapse border  px-4 py-2">{{ $Documentos->orden_compra->tel_cliente }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border-collapse border  px-4 py-2 font-bold">Email</td>
                                            <td class="border-collapse border  px-4 py-2">{{ $Documentos->orden_compra->email_cliente }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <!-- FIN - VISTA PREVIA ORDEN DE COMPRA -->
