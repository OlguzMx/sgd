    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-8 py-2">
                <div class=" pb-12">
                    <h2 class="text-base font-semibold leading-7 text-gray-900 uppercase">Datos del Documento <span
                            class="uppercase">{{ $Documentos->tipo_documento->name }}</span></h2>
                    <div class="mt-8">
                        ...
                        <div class="border px-3 py-6 rounded-sm">
                            <div class="mt-2">
                                ...
                                <div class="grid grid-cols-2 gap-2 p-4">
                                    <div
                                        style="background-color:yellow; padding:6px; border:solid 1px; border-radius:10px;">
                                        <p class="font-bold">Proveedor: <span
                                                class="font-normal">{{ $Documentos->orden_compra->proveedor->name }}</span>
                                        </p>
                                        <p class="font-bold">Dirección: <span
                                                class="font-normal">{{ $Documentos->orden_compra->proveedor->direccion }}</span>
                                        </p>
                                        <p class="font-bold">Contacto: <span
                                                class="font-normal">{{ $Documentos->orden_compra->proveedor->name_contacto }}</span>
                                        </p>
                                        <p class="font-bold">Teléfono: <span
                                                class="font-normal">{{ $Documentos->orden_compra->proveedor->telefono }}</span>
                                        </p>
                                    </div>

                                    <div
                                        style="background-color:yellow; padding:6px; border:solid 1px; border-radius:10px;">
                                        <p class="font-bold">Orden de Compra: <span
                                                class="font-normal">{{ $Documentos->orden_compra->num_orden_compra }}</span>
                                        </p>
                                        ...
                                        <p class="font-bold">Nombre del Proyecto: <span
                                                class="font-normal">{{ $Documentos->orden_compra->nombre_proyecto }}</span>
                                        </p>
                                    </div>
                                    <div
                                        style="background-color:yellow; padding:6px; border:solid 1px; border-radius:10px;">
                                    ...
                                    <div
                                        style="background-color:yellow; padding:6px; border:solid 1px; border-radius:10px;">
                                        <p class="font-bold">Tiempo de entrega: <span
                                                class="font-normal">{{ $Documentos->orden_compra->tiempo_entrega }}</span>
                                        </p>
                                        <p class="font-bold">Moneda: <span
                                                class="font-normal">{{ $Documentos->orden_compra->moneda }}</span></p>
                                    </div>
                                </div>

                                <h2 class="font-bold uppercase text-3xl text-center my-4">
                                    {{ $Documentos->tipo_documento->name }}</h2>
                                        ...
                                        @foreach ($Documentos->orden_compra->detalles_orden_compra as $detalle)
                                            <tr>
                                                ...
                                                <td class="border px-4 py-2 text-center">
                                                    <span
                                                        class="font-semibold">$</span>{{ number_format($detalle->precio_unitario, 2, '.', ',') }}
                                                </td>
                                                <td class="border px-4 py-2 text-center">
                                                    <span
                                                        class="font-semibold">$</span>{{ number_format($detalle->importe, 2, '.', ',') }}
                                                </td>
                                            </tr>
                                        @endforeach
                                        <tr>
                                            ...
                                            <td class="border px-4 py-2 text-center" colspan="1">
                                                <span
                                                    class="font-semibold">$</span>{{ number_format($Documentos->orden_compra->subtotal, 2, '.', ',') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3"></td>
                                            ...
                                            <td class="border px-4 py-2 text-center" colspan="1">
                                                <span
                                                    class="font-semibold">$</span>{{ number_format($Documentos->orden_compra->iva, 2, '.', ',') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3"></td>
                                            ...
                                            <td class="border px-4 py-2 text-center" colspan="1">
                                                <span
                                                    class="font-semibold">$</span>{{ number_format($Documentos->orden_compra->total, 2, '.', ',') }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-collapse border 200 px-4 py-2">
                                                {{ $Documentos->orden_compra->empresa->name }}</td>
                                            <td class="border-collapse border 200 px-4 py-2">
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-collapse border  px-4 py-2">
                                                {{ $Documentos->orden_compra->empresa->direccion }}</td>
