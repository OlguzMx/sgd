                    ...
                    <div class="mt-8 grid grid-cols-1 gap-x-2 gap-y-2 md:grid-cols-3">
                        ...
                        <div class="sm:col-span-3 border px-3 py-2">
                            <div class="mt-2 mx-24">
                                ...
                                <p class="text-right">Villahermosa, Tabasco a {{ \Carbon\Carbon::parse($Documentos->salida_almacen->fecha)->translatedFormat('d \d\e F \d\e Y') }}</p>
                                <p class="font-semibold">{{ $Documentos->salida_almacen->name_cliente }}</p>
                                <p class="font-semibold">{{ $Documentos->salida_almacen->empresa_cliente }}</p>
                                <p class="font-semibold">{{ $Documentos->salida_almacen->puesto_cliente }}</p>
                                ...
                                <table class="min-w-full table-auto border-collapse border border-slate-500 my-2">
                                    ...
                                    <tbody>
                                        @foreach ($Documentos->salida_almacen->detalles_salida_almacen as $detalle)
                                        <tr>
