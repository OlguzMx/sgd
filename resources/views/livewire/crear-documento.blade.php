        ...
        <div class="grid grid-cols-1 gap-y-4 sm:gap-x-6 sm:gap-y-4">
            <div class="space-y-4">
                ...
                <div x-data="{ selectedOption: '{{ $selectedOption }}' }">
                    ...
                    <select x-model="selectedOption" wire:model="tipo_documento_id"
                    ...
                    <div x-show="selectedOption === '1'" class="mt-4">
                        <div class="flex flex-col md:grid md:grid-cols-2 md:gap-6">
                            ...
                            <div>
                                ...
                                <input id="cantidad" wire:model="cantidad" type="number" min="0"
                                    class="mb-2 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                @error('cantidad')
                                    <div
                                        class="alerta my-2 p-2 border-l-4 border-l-red-700 text-sm shadow-md text-center font-bold bg-red-100">
                            ...
                            <button type="button" wire:click='detallesDocumentos'>
                                Agregar campos
                            </button>
                        </div>
                    ...
                    <div x-show="selectedOption === '4' ">
                        <div class="flex flex-col md:grid md:grid-cols-2 md:gap-6">
                            ...
                            focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm mb-2">
                                ...
                                <input wire:model="num_inventario" type="text"
                                    class="mb-2 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            ...
                            <div>
                                ...
                                <input id="num_serie_danado" wire:model="num_serie_danado" type="text"
                                    class="mb-2 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                ...
                                <input wire:model="num_serie_reemplazo" type="text"
                                    class="mb-2 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                ...
                                <input id="marca" wire:model="marca" type="text"
                                    placeholder="Ej: Aruba, Fortinet, etc."
                                    class="mb-2 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                @error('marca')
                                    <div
                                        class="alerta my-2 p-2 border-l-4 border-l-red-700 text-sm shadow-md text-center font-bold bg-red-100">
                            ...
                            <div class="col-span-2">
                                ...
                                <input wire:model="modelo" type="text" placeholder="Eje: AP-505"
                                    class="mb-2 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                @error('modelo')
                                    <div
                                        class="alerta my-2 p-2 border-l-4 border-l-red-700 text-sm shadow-md text-center font-bold bg-red-100">
