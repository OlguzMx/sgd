<div>
    <form wire:submit="editarEntradaAlmacen">
        <div class="gap-y-4 sm:gap-x-6 sm:gap-y-4">
            ...
            <div class="grid grid-cols-2 gap-8">
                ...
                <div>
                    <label for="name_cliente" class="block">Nombre de Cliente</label>
                    <input wire:model="name_cliente" id="name_cliente"
                ...
                <div>
                    ...
                    <input wire:model="puesto_cliente" id="puesto_cliente"
                        class="block w-full rounded-md border-gray-300 shadow-sm
                    focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm mb-2">
                ...
                <div>
                    ...
                    <input wire:model="empresa_cliente" id="empresa_cliente"
                        class="block w-full rounded-md border-gray-300 shadow-sm
                    focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm mb-2">
            ...
            <h4 class="text-center font-semibold text-orange-400 text-lg my-4">
                Detalles Remisión {{ $documento->entrada_almacen->id }}
            </h4>
                    ...
                    <tbody>
                        @foreach ($detalles as $index => $detalle)
                            <tr>
                                ...
                                <td class="border px-4 py-2">
                                    <input 
                                        id="marca_{{ $index }}" type="text" class="w-full rounded-md"
